...
export default function AdminEssaysPress() {
    ...
    const uploadAttachment = async () => {
        ...
        const url = await uploadToStorage(attachment, FILE_FOLDER, "essay-file", "application/octet-stream");
        return {
            url,
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const payload = {
                ...
                files: attachmentMeta ? JSON.stringify([attachmentMeta]) : null,
                file_url: attachmentMeta?.url || null,
                file_name: attachmentMeta?.label || null,
            };

            const { error } = await supabase.from("essays_press").insert(payload);
